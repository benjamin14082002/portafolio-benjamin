...
function Hero() {
  return (
    <section className="min-h-screen flex items-center justify-center pt-20 pb-10 px-6 relative overflow-hidden">
      {/* Luces de fondo dinámicas para dar profundidad */}
      <motion.div
        animate={{
          scale: [1, 1.2, 1],
          opacity: [0.3, 0.5, 0.3],
        ...
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-purple-600/10 rounded-full blur-[120px] -z-10"
      />
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-8 leading-[0.9]">
            Soluciones <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-500 via-orange-500 to-purple-500 bg-[length:200%_auto] animate-gradient">
              Full-Stack
            </span> <br />
            con visión técnica
          </h1>
        ...
        >
          Soy <span className="text-white font-semibold">Benjamín Acevedo</span>. Desarrollo ecosistemas digitales escalables desde <span className="text-white">Maipú</span>, uniendo backends robustos en Django con experiencias dinámicas.
        </motion.p>
        ...
        >
          <a href="#proyectos" className="group relative px-8 py-4 bg-white text-black font-bold rounded-2xl transition-all hover:scale-105 active:scale-95 overflow-hidden">
            <span className="relative z-10">Explorar Proyectos</span>
            <div className="absolute inset-0 bg-gradient-to-r from-purple-500 to-orange-500 opacity-0 group-hover:opacity-10 transition-opacity" />
          </a>

          <a href="#contacto" className="px-8 py-4 bg-zinc-900 text-white font-bold rounded-2xl border border-zinc-800 hover:bg-zinc-800 transition-all hover:border-zinc-700">
            Hablemos
          </a>
        </motion.div>
      </div>
